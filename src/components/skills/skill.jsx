...
<section id='skills'>
 ...
 <div className='skillBars'>
    ...
    <img src='../../../public/coding.png' alt='' className='skillBarImg'/>
    ...
    <div className='skillBar'>
    <img src='../../../public/youtube.png' alt='' className='skillBarImg'/>
    <div className='skillBarText'>
    <h2>Web-design</h2>
    ...
    <div className='skillBar'>
    <img src='../../../public/video-editing.png' alt='' className='skillBarImg'/>
    <div className='skillBarText'>
    <h2>Video-editing</h2>
